...
module.exports.run = async (bot, message, args) => {
    ...
    if (message.member.voiceChannel) {
        ...
        .then(connection => {
            ...
            .setTitle("Radio Metal")
            .setDescription("**Connected**")
            .setColor('#606060')
			.setURL("http://www.radiometal.com/")
			.setImage("https://i.imgur.com/IHEEnu2.png")
			.setTimestamp()
            connection.playArbitraryInput(`http://radio.radiometal.com/radiometal.mp3`);
